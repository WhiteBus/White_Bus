...
public final class ActivityViNearestStationBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityViNearestStationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityViNearestStationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_vi_nearest_station, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityViNearestStationBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.detailProject;
      TextView detailProject = ViewBindings.findChildViewById(rootView, id);
