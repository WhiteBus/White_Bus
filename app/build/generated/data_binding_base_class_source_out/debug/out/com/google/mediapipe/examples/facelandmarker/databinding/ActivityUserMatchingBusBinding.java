...
public final class ActivityUserMatchingBusBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityUserMatchingBusBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityUserMatchingBusBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUserMatchingBusBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_user_matching_bus, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUserMatchingBusBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUserMatchingBusBinding((ConstraintLayout) rootView, addressBoard,
          busNumBtn, dstInfo, userAddress, userAddressDstName, userBtnBoard, userBusTime);
    }
